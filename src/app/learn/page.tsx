    ...
    <DashboardLayout>
      <div className="flex-1 flex flex-col items-center justify-center max-w-4xl mx-auto w-full px-4 h-full min-h-[70vh]">
        ...
        <div className="relative mb-8">
          {/* Outer glow */}
          <div className="absolute inset-0 scale-150 bg-gradient-to-tr from-pink-300/40 via-purple-300/40 to-yellow-300/40 rounded-full blur-2xl animate-pulse"></div>
          {/* Orb core */}
          <div className="w-24 h-24 rounded-full bg-gradient-to-tr from-pink-400 via-purple-200 to-yellow-200 shadow-[0_0_40px_rgba(236,192,255,0.6)] relative z-10"></div>
          <div className="absolute top-2 right-4 w-8 h-8 rounded-full bg-white/40 blur-sm z-20"></div>
        </div>
        ...
        <div className="w-full relative mt-auto">
           <div className="absolute inset-0 bg-white shadow-[0_0_40px_rgba(0,0,0,0.04)] rounded-3xl border border-black/5 pointer-events-none"></div>
           <div className="relative z-10 bg-white rounded-3xl p-2 flex flex-col pt-4 px-4 min-h-[120px]">
             ...
             <div className="flex items-center justify-between mt-auto py-2 border-t border-slate-50">
               ...
               <button className={`w-8 h-8 rounded-full flex items-center justify-center transition-colors ${prompt.trim() ? 'bg-primary text-white shadow-sm' : 'bg-slate-100 text-slate-400'}`}>
